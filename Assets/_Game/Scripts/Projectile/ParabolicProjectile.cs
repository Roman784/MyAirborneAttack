...
namespace Gameplay
{
    public class ParabolicProjectile : Projectile
    {
        ...
        public ParabolicProjectile(ProjectileView view, ShootingData shootingData, Vector3 flightDirection) : base(view, shootingData)
        {
        ...
        protected override void Move()
        {
            ...
            var y = _initialPosition.y + _initialFlightVelocity.y * _flightTime + (GRAVITY * _flightTime * _flightTime) / 2f;
        ...
        public static void DrawTrajectory(Transform socket, float initSpeed)
        {
            ...
            for (int i = 0; i < capacity; i++)
            {
                ...
                var y = initPos.y + initVel.y * t + (GRAVITY * t * t) / 2f;
